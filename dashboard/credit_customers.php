                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Credit Customer</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Credit Customer List </a></li>
                            ...
                            <table class="table table-bordered table-dark">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        WHERE paid_status='partial_paid' or paid_status='full_due' order by payments.id desc";
                                        $qrys = mysqli_query($conn, $sqls);
                                        $sln = 1;
                                        $totaldue = 0;
                                        while($rs = mysqli_fetch_assoc($qrys)){
                                            $id = $rs['invoice_id'];
                                            $totaldue +=$rs['due_amount'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?php 
                                            if($rs['paid_status']=='full_paid'){
                                                ...
                                                echo "<span class='badge bg-danger'>Full Due</span>";
                                            }; 
                                        ?></td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="5" class="text text-right">Total Due</td>
