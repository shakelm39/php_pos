...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $sqls = "UPDATE suppliers SET name='$name', mobile_no='$mobile_no',email='$email',address='$address' WHERE id='$id'";

        $query = mysqli_query($conn, $sqls);

        if($query){
            $msg= '<div class="alert alert-success alert-dismissible"><span class="close" data-dismiss="alert" aria-label="close">x</span>Supplier Successfully Updated!</div>';
            header('Location: view_suppliers.php?msg='.$msg);
        }else{
            $msg= '<div class="alert alert-danger alert-dismissible"><span class="close" data-dismiss="alert" aria-label="close">x</span>Supplier Update Failed!</div>';
            header('Location: view_suppliers.php?msg='.$msg);
        }
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Update Suppliers </a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <a href="view_suppliers.php" class="btn  btn-primary float-right"><i class="fa fa-eye"> View Suppliers</i></a>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation" novalidate action="edit_suppliers.php" method="POST">
                            <div class="col-md-12">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary mt-3" type="submit" name="submit">Update Supplier</button>
                            </div>
                        </form>
                    </div>
                </div>
