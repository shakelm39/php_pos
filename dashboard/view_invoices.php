        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <a href="add_invoice.php" class="btn  btn-primary float-right"><i class="fa fa-plus"> Add Invoice</i></a>
                    </div>
                            ...
                            <table class="table table-bordered table-striped" id="example">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        JOIN customers
                                        ON payments.customer_id = customers.id order by payments.id desc";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="delete_invoice.php?id=<?php echo $id; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete this data?');"> <i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                    <?php
                                        $sln++; 
