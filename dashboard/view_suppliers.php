                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Suppliers List </a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" class="btn  btn-primary float-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"> Add Supplier</i></button>
                    </div>
                            ...
                            <table class="table table-bordered table-striped" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-active">
                                        ...
                                        <td>
                                            <a href="edit_suppliers.php?id=<?php echo $id; ?>"  class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> </a>
                                            <a href="delete_suppliers.php?id=<?php echo $id; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete this data?');"> <i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                    <?php
                                        $sln++; 
						...
						<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="add_supplier.php" method="POST">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary mt-3" type="submit" name="submit">Add Supplier</button>
                                        </div>
                                        </form>
									</div>
